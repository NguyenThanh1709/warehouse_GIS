...
// //Xử lý phân trang
$allUserNum = getRows("SELECT id FROM `tbl_danhmuc_sanpham` $filter");
...
$listSupiliers = getRaw("SELECT * FROM `tbl_danhmuc_sanpham` $filter LIMIT $offset, $perPage");
      ...
      <div class="col-8">
        ...
        <div class="card">
          <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
            ...
            <div class="form-search form-inline">
              <form action="#" class="d-flex">
                <input type="hidden" name="module" value="category_products">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo !empty($item['dscription']) ? "<span class='badge badge-pill badge-primary'>$item[dscription]</span>" : "<span class='badge badge-pill badge-danger'>Chưa thiết lập</span>" ?></td>
                      <td>
                        <a href="?module=category_products&view=edit&id=<?php echo $item['id']; ?>" class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                        <a onclick="return confirm('Bạn có chắc chắn xoá dữ liệu!')" href="?module=category_products&action=delete&id=<?php echo $item['id']; ?>" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                  endforeach;
          ...
          <div class="card-footer">
            <?php echo getPaging($page, 'category_products', $queryString, $maxPage) ?>
          </div>
        </div>
      </div>
    </div>
